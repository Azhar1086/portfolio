      ...
      <div className="contact-wrapper">
        <div className="direct-contact-container">
          <ul className="contact-list">
            <li className="list-item">
              ...
              <span className="contact-text phone">
                <a href="tel:3101495655" title="Give me a call">
                  +92-3101495655
                </a>
              </span>
            </li>
            <li className="list-item">
              ...
              <span className="contact-text gmail">
                <a href="mailto:muhammad24azhar02@gmail.com" title="Send me an email">
                muhammad24azhar02@gmail.com
                </a>
              </span>
            </li>
          </ul>
          ...
          <ul className="social-media-list">
            <li>
              <a href="https://www.facebook.com/azhar1086" target="_blank" className="contact-icon" rel="noreferrer">
                <FontAwesomeIcon icon={faFacebook} aria-hidden="true" />
              </a>
            </li>
            <li>
              <a href="https://www.instagram.com/hafizazhar1086" target="_blank" className="contact-icon" rel="noreferrer">
